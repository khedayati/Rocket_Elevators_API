...
connection = PG::Connection.new(host:'codeboxx-postgresql.cq6zrczewpu2.us-east-1.rds.amazonaws.com',port:'5432',dbname:'data_warehouse',user:'codeboxx',password:'Codeboxx1!')
